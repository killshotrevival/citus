...
# dbname="$POSTGRES_DB"
# echo "starting"
# ls /var/lib/postgresql/data/postgresql.conf -la
...
echo "Starting"
sed -i 's/citus/citus,pg_cron,pg_partman_bgw/' /var/lib/postgresql/data/postgresql.conf
echo "cron.database_name = 'tbox_urgs'" >> /var/lib/postgresql/data/postgresql.conf
